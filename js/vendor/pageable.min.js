        ...
        return (
            (g.prototype.init = function () {
                if (!this.initialised && !this.container.pageable) {
                    ...
                    this.config.onInit.call(this, d),
                        ...
                        a.slideshow && "function" == typeof f && ((this.slider = new f(this)), this.slider.start());
                }
            }),
            ...
            (g.prototype.update = function () {
                clearTimeout(this.timer),
                    (this.data = { window: { width: window.innerWidth, height: window.innerHeight }, container: { height: this.wrapper.scrollHeight, width: this.wrapper.scrollWidth } });
            ...
            (g.prototype.orientate = function (a) {
                ...
                this.horizontal
                    ? (this.wrapper.classList.add("pg-horizontal"), this.wrapper.classList.remove("pg-vertical"))
                    : (this.wrapper.classList.add("pg-vertical"), this.wrapper.classList.remove("pg-horizontal")),
            ...
            (g.prototype._stop = function (a) {
                ...
                if ((this.config.slideshow && this.slider.start(), this.dragging && !this.scrolling)) {
                    ...
                    return (
                        (this.dragging = h),
                        g && (this.config.infinite && this._overScroll(0 > h, h), 0 < h ? e() : d()),
            ...
            (g.prototype._overScroll = function (a) {
                ...
                c === this.lastIndex && a
                    ...
                    : 0 === c && !a && (c--, this._scrollBy(this.data.window[this.size[this.axis]] - b, c));
            }),
